...
**Live → https://baditaflorin.github.io/mesh-step-relay/**

**Source → https://github.com/baditaflorin/mesh-step-relay**
...
git clone https://github.com/baditaflorin/mesh-step-relay
cd mesh-step-relay
npm install
npm run dev
```
...
- `mesh-step-relay:signalingUrl`
- `mesh-step-relay:turnTokenUrl`
- `mesh-step-relay:iceServers`
- `mesh-step-relay:room`
